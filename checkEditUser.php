...
$userModificationTime = time();
if((new DataBaseUpdate($dbConnection->connection()))->inTableUsers(new User($_POST['userName'],$_POST['email'],new Password($_POST['password'].$userModificationTime)),$userModificationTime)) {
    $_SESSION['user'] = $_POST['userName'];
    (new Redirection())->to("index.php?UserModification=OK");
}
